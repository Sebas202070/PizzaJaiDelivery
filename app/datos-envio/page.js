...
const DatosEnvio = () => {
    ...
    <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-between items-stretch gap-y-8">
            ...
            <div className="w-full lg:w-1/2 lg:mr-4">
                ...
                {!showPaymentOptions ? (
                    <button
                        ...
                        className="bg-blue-500 hover:bg-blue-600 text-white py-3 px-6 rounded-lg mr-4 mb-4"
